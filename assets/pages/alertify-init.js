...
(function() {
    ...
    // 点击出现结果
    // demo("#alertify-success-1", function (ev) {
    //     alertify.logPosition("bottom right");
    //     // alertify.log("top right");
    //     alertify.success("Success! Check the results in Visualization");
    //     $("#div1").fadeOut(3000);
    //     $("#div2").fadeOut(3000);
    //     $("#div3").fadeOut(3000);
    // });

    // demo("#alertify-success-2", function (ev) {
    //     alertify.logPosition("bottom right");
    //     // alertify.log("top right");
    //     alertify.success("Success! Check the results in Visualization");
    // });

    // demo("#alertify-success-3", function (ev) {
    //     alertify.logPosition("bottom right");
    //     // alertify.log("top right");
    //     alertify.success("Success! Check the results in Visualization");
    // });
