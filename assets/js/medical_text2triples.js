...
function($) {
    ...
    function Func_Extration(text) {
        ...
        var request_url = "http://openue.top:8890/IEDemo?q=" + text;
		...
		// }
		// else{
		// 	$(window).attr('location','medical_text2triples.html');
		// }
    };
    ...
    function Func_DrawTable(data){
        ...
        var bar_input = data.class_prob;
        var graph_input = data.spo_list;
        var tmpt = null;

        for(var i in data.spo_list){
            tmpt = data.spo_list[i];
